...
print(f"{hashtreeroot=}")

#get hashtreeroot using custom function
expected_hashtreeroot = get_hash_tree_root_beacon_block_header(slot_ssz, proposer_index_ssz, parent_root_ssz, state_root_ssz, body_root_ssz)
